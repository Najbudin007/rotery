     ...
     <div class=" mt-4">
         <div class="card">
             <div class="card-header text-center font-weight-bold d-flex justify-content-between w-100">
                 ...
                 <a href="{{ route('permission.create') }}" class="btn btn-sm btn-outline-success ml-auto">Add
                     Permission</a>
             </div>
             <div class="card-body">
 ...
 <script type="text/javascript">
     ...
     $(document).on('click', 'button#deleteAllBtn', function() {
         ...
         let url = "{{ route('deleteSelectedPermission') }}";
         if (checkedData.length > 0) {
             confirm("Are you sure to delete selected permission? Action cannot be reverted.")
             $.post(url, {
                 ids: checkedData,
                 "_token": "{{ csrf_token() }}"
             }, function(data) {
