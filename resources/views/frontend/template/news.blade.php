<div
class="bg-bgLightSecondary px-4 py-6 md:p-10 lg:px-16 space-y-7 lg:flex lg:flex-col"
style="flex: 2"
>
<div class="flex justify-between">
  <div
    class="text-xl lg:text-2xl text-textDarkSecondary font-playFair font-700"
  >
    OUR NEWS
  </div>
  <a
...
<div class="news-swiper lg:hidden overflow-hidden">
  ...
  <div class="swiper-wrapper">
    ...
    <div
      class="bg-white space-y-3 news-card rounded-xl swiper-slide"
    >
      <div>
        <img
      ...
      <div
        class="px-4 border-l border-secondary"
        style="border-left-width: 3px"
      >
        <a
          href="news/news-detail.html"
          class="text-sm text-primary font-600"
        >
  ...
  <div class="flex space-x-8 h-full">
    ...
    <div class="bg-white news-card rounded-xl flex flex-col">
      ...
      <div class="flex flex-col justify-between py-6 space-y-4">
        ...
        <div
          class="text-sm text-textDarkSecondary px-4 leading-7 line-clamp-2"
        >
          Lorem Ipsum is simply dummy text of the printing and
          typesetting industry. Lorem Ipsum is simply dummy text of
          the printing and typesetting industry.
        </div>
        <div class="text-secondary text-xxs px-4">12-20-2021</div>
      </div>
    </div>
