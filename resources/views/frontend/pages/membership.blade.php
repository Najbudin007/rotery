...
@section('content')
    <div class="max-w-4xl mx-auto p-4 md:p-10 xl:px-14">
        <div class="text-textDark">
            ...
            <form class="space-y-4 lg:space-y-6 comment-form">
                <!-- Membership Category -->
                <div class="text-xs font-600 space-y-4 lg:font-500">
                    ...
                    <div class="font-500 space-y-4 lg:flex lg:space-y-0 lg:space-x-14">
                        <div class="flex space-x-2 lg:items-start">
                            <input type="checkbox" id="membership-full-membership" class="border mt-1">
                            <label for="membership-full-membership">Full membership (with more than 5 years of
                                service)</label>
                        </div>
                        <div class="flex space-x-2 lg:items-start">
                            <input type="checkbox" id="membership-associate-membership" class="border mt-1">
                ...
                <div class="text-xs font-600 space-y-4 lg:font-500 py-4 lg:py-0">
                    ...
                    <div class="font-500 space-y-4 lg:flex lg:space-y-0 lg:space-x-14">
                        <div class="flex space-x-2 lg:items-start">
                            <input type="checkbox" id="fees-life-membership" class="border">
                            <label for="fees-life-membership">Life Membership (one single payment of RS.100,000)</label>
                        </div>
                        <div class="flex space-x-2 lg:items-start">
                            <input type="checkbox" id="fees-annual-membership" class="border">
                ...
                <div class="text-xs font-500">
                    ...
                    <input type="text" id="name" class="border w-full px-4 py-2.5 rounded-md focus:border-gray-400"
                ...
                <div class="text-xs font-500">
                    ...
                    <input type="email" id="email" class="border w-full px-4 py-2.5 rounded-md focus:border-gray-400"
                    ...
                    <div class="font-500 text-xs space-y-4 lg:space-y-6">
                        <div class="md:grid space-y-4 md:space-y-0 md:gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="date" id="year" value="2022-12-30" min="1980-01-01" max="2050-12-31"
                                    class="border w-full px-4 py-2.5 rounded-md focus:border-gray-400">
                            </div>
                            ...
                            <div class="md:col-span-2 lg:col-span-1">
                                ...
                                <div class="relative">
                                    <input type="text" id="duty-station"
                                        class="border w-full px-4 py-2.5 rounded-md focus:border-gray-400"
                        ...
                        <div class="text-xs font-500">
                            ...
                            <textarea id="expertise-area" rows="6"
