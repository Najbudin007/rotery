    ...
    <div class="px-4 py-6 md:p-10 xl:px-14">
      <div>
        ...
        <div class="py-6">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 lg:gap-8 pt-6">
            ...
            <div class="bg-white member-card rounded-xl">
              <div>
                <img src="../resources/images/about/board-members/board-member-1.png" alt="Charter President" class="w-full h-36 md:h-44 lg:h-52 object-cover">
              </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 lg:gap-8">
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-1.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-2.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-3.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-4.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-5.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-6.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-7.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-8.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
          ...
          <div class="bg-white member-card rounded-xl">
            <div>
              <img src="../resources/images/about/board-members/board-member-9.png" alt="Charter Member" class="w-full h-36 md:h-44 lg:h-52 object-cover">
            </div>
            <div class="text-sm text-primary border-l my-3 border-secondary px-4" style="border-left-width: 3px">
              <div class="font-600 text-sm">Ram Sharma</div>
              <div class="text-xs">ABCD President</div>
