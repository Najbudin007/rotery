                ...
                <div class="lg:flex lg:items-center lg:space-x-8">
                    ...
                    <div class="hidden lg:block lg:flex-1">
                        <div class="space-x-8 flex">
                            <div class="space-y-8">
                                <div>
                                    <img src="{{ asset('images/' . $about_club->who_image1) }}" alt="Golf"
                                        class="h-80 w-full" />
                                </div>
                                <div>
                                    <img src="{{ asset('images/' . $about_club->who_image2) }}" alt="Golf"
                                        class="h-56 w-full" />
                                </div>
                            </div>
                            <div class="space-y-8">
                                <div>
                                    <img src="{{ asset('images/' . $about_club->who_image3) }}" alt="Golf"
                                        class="h-56 w-full" />
                                </div>
                                <div>
                                    <img src="{{ asset('images/' . $about_club->who_image4) }}" alt="Golf"
                                        class="h-80 w-full" />
                                </div>
                            </div>
                        </div>
            ...
            <div class="px-4 pb-6 md:p-10 md:pt-0 xl:px-14 xl:py-20">
                <div class="lg:flex lg:items-center lg:space-x-8">
                    <div class="space-y-5 lg:flex-1">
                        ...
                        <div class="flex space-x-5 lg:hidden">
                            <div class="flex-1">
                                <img src="{{ asset('images/' . $about_club->why_image1) }}" alt="Golf"
                                    class="w-full h-60" />
                            </div>
                            <div class="flex-1 hidden md:block">
                                <img src="{{ asset('images/' . $about_club->why_image2) }}" alt="Golf"
                                    class="w-full h-60" />
                            </div>
                        </div>
                        <div class="text-sm text-textLight md:text-black md:font-300 leading-7"
                    ...
                    <div class="hidden lg:block lg:flex-1">
                        <div class="space-x-8 flex">
                            ...
                            <div class="space-y-8">
                                <div>
                                    <img src="{{ asset('images/' . $about_club->why_image3) }}" alt="Golf"
                                        class="h-56 w-full" />
                                </div>
                                <div>
                                    <img src="{{ asset('images/' . $about_club->why_image4) }}" alt="Golf"
                                        class="h-80 w-full" />
                                </div>
                            </div>
                        </div>
