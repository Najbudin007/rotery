<nav class="text-textDark z-20 sticky top-0 bg-white shadow">
    ...
    <div
      class="flex justify-between items-center px-4 lg:hidden relative mobile-nav"
    >
  ...
  >
    <div class="absolute top-0 left-0 h-screen bg-white">
      <div
        ...
        style="width: 340px; max-width: 95vw; padding: 22px"
      >
        ...
        <div>
          ...
          <div class="border-b sidebar-item flex items-center">
            <a
              href="index.html"
              class="flex-1 flex h-full space-x-4 py-3 cursor-pointer"
            >
              <div>
                <img
          ...
          <div class="border-b sidebar-item">
            ...
            <div
              class="overflow-hidden collapse-menu transition-all duration-300"
              style="height: 0px"
            >
          ...
          <div class="border-b sidebar-item">
            ...
            >
              <div class="space-y-6 pl-8 flex flex-col">
                ...
                >
                <a href="projects/individual-project.html"
                  >Earthquake Relief Assistance</a
                >
                <a href="projects/individual-project.html"
                  >Looking For Funding</a
                >
          ...
          <div class="border-b sidebar-item">
            ...
            >
              <div class="space-y-6 pl-8 flex flex-col">
                <a href="photos/rotary-year-photos.html"
                  >Rotary Year Photos</a
                >
                <a href="photos/videos.html">Videos</a>
              </div>
            </div>
          </div>
          ...
          <div class="border-b sidebar-item flex items-center">
            <a
              ...
              class="flex-1 py-4 flex space-x-4 cursor-pointer"
            >
              <div>
                <img
          ...
          <div class="border-b sidebar-item flex items-center">
            <a
              ...
              class="flex-1 py-4 flex w-full space-x-4 cursor-pointer"
            >
              <div>
                <img
  ...
  <div class="hidden lg:block bg-white shadow z-20 sticky top-0">
    ...
    <div class="relative" style="height: 55px">
      <div
        class="max-w-7xl mx-auto hidden lg:block h-full font-openSans font-600"
      >
        <div class="px-10 xl:px-14 flex h-full">
          <div
            class="w-72 xl:w-80 flex-shrink-0 bg-white relative flex justify-between items-center"
          >
            <div
            ...
            <div
              class="absolute bottom-0 right-0 h-1.5 w-20 bg-secondary"
            ></div>
          </div>

          <div
            class="flex-1 bg-primary text-white flex text-xs font-openSans"
          >
            <!-- About -->
            <div class="relative group h-full">
              ...
              <div
                class="absolute top-full left-0 bg-primary hidden group-hover:block shadow-xl"
                style="padding: 27px"
              >
                <a
            ...
            <div class="relative group h-full">
              ...
              >
                <a
                  href="photos/rotary-year-photos.html"
                  class="truncate cursor-pointer block"
                >
                  Rotary Year Photos
                </a>
                <a
                  href="photos/videos.html"
                  class="cursor-pointer block"
                  style="margin-top: 14px"
                >
                  Videos
      ...
      <div
        class="absolute top-0 -z-10 left-1/2 h-full w-1/2 bg-primary"
      ></div>
    </div>
  </div>
