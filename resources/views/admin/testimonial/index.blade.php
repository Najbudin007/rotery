...
@section('content')
        ...
        <div class=" mt-4">
            <div class="card">
                <div class="card-header text-center font-weight-bold d-flex justify-content-between w-100">
                    <h4 class="my-auto">Testimonial Table</h4>
                    <button class="btn btn-sm btn-danger mx-2 d-none" id="deleteAllBtn">Delete All</button>

                    <a href="{{ route('testimonial.create') }}" class="btn btn-sm btn-outline-success ml-auto">Add
                        Testimonial</a>
                </div>
                <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', 'button#deleteAllBtn', function() {
            ...
            let url = "{{ route('deleteSelectedTestimonial') }}";
