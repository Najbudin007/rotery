                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="link" class="form-control" placeholder="Enter slider redirection link."
                                    value="{{ $slider->link }}" name="link" required>
                                @error('title')
                                    <div class="text-red">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" placeholder="Enter description" value="{{ $slider->description }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control" required>
                                    ...
                                    <option value="inactive" @if ($slider->status === 'inactive') selected @endif>Inactive
                                    </option>
                                </select>
                                @error('status')
                                    <div class="text-red">
